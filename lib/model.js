        ...
        this.sync(options)
          ...
          .tap(function(response) {
            if (!response || response.length === 0) {
              if ((this.requireFetch && options.require !== false) || options.require) {
                throw new this.constructor.NotFoundError('EmptyResponse');
              } else return this._handleResponse(response, options);
            }
          })

          // Now, load all of the data into the model as necesary
          ...
          .tap(function(response) {
            if (!response || response.length === 0) return this._handleResponse(response, options);
